	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            orderTitle: 'Bang',
                            thumbnail: fs.readFileSync('./src/krizyn.jpg'), //Gambarnye
...
const flokasi = {
	key : {
       ...
       message: {
                    locationMessage: {
                    name: 'Russia',
                    jpegThumbnail: fs.readFileSync('./src/krizyn.jpg')
                          }
                        }
                      }
...
//FAKEREPLY KONTAK
 const fcon = {
	 ...
	 participant: `0@s.whatsapp.net`, ...(m.chat ? 
	 { remoteJid: "status@broadcast" } : {}) },
	 message: { "contactMessage": { "title":"sri","h": `haloo`, 'jpegThumbnail': fs.readFileSync('./src/krizyn.jpg')}}
	}
	...
	const fcona = {
	 ...
	 participant: `0@s.whatsapp.net`, ...(m.chat ? 
	 { remoteJid: "status@broadcast" } : {}) },
	 message: { "contactsArrayMessage": { "title":"antibot","h": `aloo`, 'jpegThumbnail': fs.readFileSync('./src/krizyn.jpg')}}
	}
