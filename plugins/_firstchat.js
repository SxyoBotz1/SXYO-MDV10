...
let tag = `@${m.sender.split('@')[0]}`
 ...
 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}
    ...
    let tks = `Saya adalah Krizyn salah satu Bot Whatsapp yang diciptakan oleh : ${ow}
Silahkan tekan Tombol ${user.registered ? '"Menu"' : '"Verify"'} untuk ${user.registered ? 'melihat list command dari' : 'mendaftar sebelum menggunakan'} Krizyn.
